...
layout_3 = html.Div([
    html.Div([
        dcc.Graph(id='line_l3', style = {'order':'3', 'border-radius': '5px', 'width': '810px', 'height': '500px', 'backgroundColor': 'white', 'padding': '5px', 'margin-top': '2rem'}),
        dcc.Graph(id='waterfall_l3', style = {'order':'4', 'border-radius': '5px', 'width': '810px', 'height': '500px', 'backgroundColor': 'white', 'padding': '5px', 'margin-top': '2rem'}),
        html.H1(['2021 Iowa Liquor Sales',html.Br(),'Custom dashboard'], style = {'order':'1', 'color': '#a4e57a', 'margin-top': '2rem', 'text-align': 'left'}),
        dbc.Button("New dashboard", id = 'new-button', className="me-1", n_clicks=0, style = {'order':'2', 'margin-top': '1vh'}),
    ], style = {'order':'1', 'height': '80vh', 'width': '50vw', 'display': 'flex', 'flex-direction': 'column', 'align-items': 'flex-start', 'margin-left': '7rem'}),
    
    html.Div([
        html.Div(id = 'upper-plots-l3', children = [], style = {'order': '1'}),
        html.Div(id = 'waterfall-chart_l3', children = [], style = {'order': '2'})],
        style = {'order':'2', 'height': '80vh', 'width': '35vw', 'display': 'flex', 'flex-direction': 'column', 'align-items': 'center', 'justify-content': 'flex-end', 'margin-right': '2.3rem', 'margin-top': '13.6vh'})
...
def create_waterfall_chart(data):
    ...
    return html.Div([
        html.H2('Profits and loss statement 2021', style = {'order': '5', 'color': '#a4e57a', 'margin-bottom': '0.5rem'}),
        dcc.Graph(figure=fig, style = {'backgroundColor': 'white', 'border-radius': '5px', 'width': '540px', 'height': '310px', 'padding': '5px'})
    ])
...
def create_donut_chart(data):
    ...
    return html.Div([
            html.Div([
                html.H2('Sales per weekday', style = {'color': '#a4e57a', 'margin-bottom': '0.5rem', 'font-size': '26px', 'margin-left': '1.7vw'}),
                dcc.Graph(figure=fig, style = {'width': '260px', 'height': '310px', 'padding': '5px'})
            ], style = {'order': '2', 'margin-left': '0.5vw'}),
            html.Div([
                html.H2('Most profitable items', style = {'color': '#a4e57a', 'margin-bottom': '0.5rem', 'font-size': '26px'}),
